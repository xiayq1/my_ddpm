...
def main():
    ...
    for iteration in range(1, args.iterations + 1):
        ...
        if iteration % args.log_rate == 0:
            ...
            print("iteration: ", iteration, "test_loss: ", test_loss, "train_loss: ", acc_train_loss)

            acc_train_loss = 0
        
        if iteration % args.checkpoint_rate == 0:
            model_filename = f"{args.log_dir}/label_{args.project_name}-{args.run_name}-iteration-{iteration}-model.pth"
            optim_filename = f"{args.log_dir}/label_{args.project_name}-{args.run_name}-iteration-{iteration}-optim.pth"
